export const timelineEvents = [
  ...
  {
    date: "MAR 8 · 06:00 UTC",
    title: "Expanded SEAD operations and targeted command node strikes",
    description:
      "Sustained pressure on Iranian air defenses while targeting secondary command and control nodes. ISR flights continue monitoring for mobile missile launcher movements.",
    cost: "$90,000,000",
  },
];
    ...
    <div className="w-full max-w-3xl font-mono text-zinc-300">
      ...
      <div className="relative pl-6 pb-4">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(239,68,68,0.3) 0%, rgba(255,255,255,0.06) 50%, transparent 100%)",
          }}
        />
        ...
        {allEvents.map((event, i) => (
          <div key={i} className="mb-10 last:mb-0 relative group">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {event.cost && (
                <p className="text-sm mt-1 font-mono font-medium text-gradient-red inline-block">
